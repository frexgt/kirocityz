	...
	if CLIENT then
		...
		function hg.CalculateConsciousnessMul()
			...
			if org and org.consciousness then
				...
				consciousness = consciousness * math_Clamp(org.blood / 5200, 0.5, 1)
				consciousness = consciousness * math_Clamp(org.o2[1] / 25, 0.5, 1)
		...
		hook.Add("ViewpunchThink", "viewpunch_think", function(tblang)
			...
			local add = vp_punch_angle - vp_punch_angle_last + vp_punch_angle2 - vp_punch_angle_last2 + vp_punch_angle3 - vp_punch_angle_last3 + vp_punch_angle4 - vp_punch_angle_last4
			...
			vp_punch_angle_last4 = vp_punch_angle4
		end)
